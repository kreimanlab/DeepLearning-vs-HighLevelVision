#inference then finetuning of all layers
...
#'/home/vj34/images/cats-dogs/'
train_data_dir = '/train_dir/'
log_folder = 'resnetV2-ft'
...
"""
ResNet50 end of conv4 = layers[142:], end of conv3 = layers[80:], end of conv3 = layers[38:]
ResNet50V2 : 153, 85, 39
VGG16 : 9, 13 (total 19 layers)
InceptionV3 : 249, 200, 168
InceptionResNetV2 : 621, 438, 266
"""
...
fit_history_2 = model.fit_generator(generator=train_generator,
                    steps_per_epoch=STEP_SIZE_TRAIN,
                    validation_data=valid_generator,
                    epochs=NUM_EPOCHS,
                    callbacks=[cb_checkpointer, cb_early_stopper, csv_record_train]
...
def export_history_2(log_folder, history_):
    with open(log_folder  + '/history_2.csv', 'a') as csvfile:
        for key in history_.history.keys():
            csvfile.write("%s : %s \n\n"%(key, history_.history[key]))

export_history_2(log_folder, fit_history_2)
