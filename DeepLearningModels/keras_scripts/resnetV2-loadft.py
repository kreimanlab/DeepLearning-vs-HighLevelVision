# Load the weights of a model with model.load_weights()
# Then finetune the last layers of the network
...
log_folder = 'resnetV2-loadft'
weights_path = '/path/best.hdf5'
...
# pred from predict_generator, valid_generator.filenames, log_folder
