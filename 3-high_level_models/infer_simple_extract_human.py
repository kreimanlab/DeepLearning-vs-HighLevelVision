...
def main(args):
    ...
    #ADDED declare lists to store kps or features
    kps_tab = []
    missed_human = []
    feats_tab = []
    for i, im_name in enumerate(im_list):
        ...
        print('cls_keyps')
        print(cls_keyps)
        #ADDED several values returned
        extracted_kps, human_feats, one_human_assigned = vis_extract_hmn.vis_extract_func(
        ...
        if extracted_kps is not None:
            kps_tab.append([im_name, extracted_kps])
        else:
